...
4. **Strategy and move recommendation** — proposes specific negotiation moves adapted to the cultural context: opening style, concession sequencing, trust-building actions, face-saving tactics, reframing language. Move recommendations include specific direct→adapted communication examples drawn from the Execution Layer (KB Part VI), not only abstract framing principles.
...
- **It gives sequenced, actionable moves with specific language.** Not "rebuild trust" but "in your next message, acknowledge the delay before raising the commercial point." Not "be more indirect" but "instead of 'we need an answer by Friday,' use 'we look forward to hearing your thoughts when you are ready to share them.'" The adapted phrase is the deliverable, not the principle.
